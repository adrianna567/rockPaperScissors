...
Second we will create code that takes they input (choices) of the user
Third we will create code that creates the input(choices) of the computer
...
Finally, we will loop the whole game, so that the user can play until they choose to quit
'''
...
while(keepPlaying): 
    ...
    print("Best two our of three. Press 'q' to quit.")
    cpuScore = 0
    humanScore = 0
    ...
    while(humanScore < 2 and cpuScore < 2): 
        ...
        # this if statement checks if the human wins
            ...
            print("Human: " + humanScore.__str__() + " CPU: " + cpuScore.__str__())
        # this if statement check if the computer wins 
